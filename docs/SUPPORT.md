...
2. Review the [Documentation](#documentation) section
...
| "Cannot manage users with equal or higher privileges" | Role hierarchy | Only higher roles can manage lower roles |
...
| Settings | Account and system information |
