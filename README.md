Flask Advanced Admin App — README

This project is a full-stack admin portal built with:
...
curl -X POST http://localhost:9000/auth/login \  
  ...
  -d '{"email":"admin@webforxtech.com", "password":"admin123"}'
...
VALUES ('newadmin@webforxtech.com', '$2b$12$dummyhash...', 'admin');
